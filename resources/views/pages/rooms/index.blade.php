                ...
                <div class="row align-items-center">
                    <div class="col">
                        <div class="mt-5">
                            ...
                            <a href="{{ route('rooms.create') }}" class="btn btn-primary float-right veiwbutton">Add
                                Room</a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        ...
                                                        <a
                                                            href="profile.html">{{ $room->name }}<span>{{ $room->bkg_room_id }}</span></a>
                                                    </h2>
                                                </td>
                                                    ...
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item"
                                                                href="{{ url('rooms/' . $room->bkg_room_id .'/edit') }}">
