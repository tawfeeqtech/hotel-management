...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <form action="{{ route('bookings.update',$bookingEdit->bkg_id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="sel2" name="room_type">
                                        <option selected value="{{ $bookingEdit->room_type }}">{{ $bookingEdit->room_type }}
                                        </option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" name="total_numbers"
                                        value="{{ $bookingEdit->total_numbers }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cal-icon">
                                        <input type="text" class="form-control datetimepicker" name="arrival_date"
                                            value="{{ $bookingEdit->arrival_date }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="cal-icon">
                                        <input type="text" class="form-control datetimepicker" name="depature_date"
                                            value="{{ $bookingEdit->depature_date }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
...
// single script after loading the script file
@push('script')
    <script>
        $(function() {
